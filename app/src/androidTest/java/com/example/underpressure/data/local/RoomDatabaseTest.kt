package com.example.underpressure.data.local
...
class RoomDatabaseTest {
    ...
    private lateinit var measurementDao: com.example.underpressure.data.local.dao.MeasurementDao
    private lateinit var appSettingsDao: com.example.underpressure.data.local.dao.AppSettingsDao
