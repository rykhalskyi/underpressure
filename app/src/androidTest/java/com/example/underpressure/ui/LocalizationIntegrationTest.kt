...
class LocalizationIntegrationTest {
    ...
    fun setUp() {
        ...
        every { shareViewModel.uiState } returns MutableStateFlow(com.example.underpressure.ui.table.ShareUiState())
